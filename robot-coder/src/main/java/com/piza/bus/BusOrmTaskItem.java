 ...
 *
 */
public class BusOrmTaskItem extends BaseItem {

    private static final Logger logger= Logger.getLogger(BusOrmTaskItem.class);

    public BusOrmTaskItem(TaskBase taskBase) {
        super(taskBase);
    }
...
//            sendChat("wrong param, example:\n code table1 table2 ...");
    ...
    private boolean commitCode(){
        ...
        try {
            String pullCmd = workingDir + File.separator + "commitProject.sh "+ConfigUtil.getStrProp("bus.projectDir");
    ...
    private void getTableList(List<String> tableList,String command){
        ...
        if(cmdArr.length<3){
            sendChat("wrong command: hint:\n bus code [tablename1] [tablename2] ...");
            return;
        }
        int ind=0;
    ...
    public boolean generate(List<String> tableList){
        ...
        try {
            ...
            configuration.addClasspathEntry(ConfigUtil.getStrProp("bus.classPathEntry"));
            ...
            jdbcConnectionConfiguration.setConnectionURL(ConfigUtil.getStrProp("bus.connectionURL"));
            jdbcConnectionConfiguration.setUserId(ConfigUtil.getStrProp("bus.userId"));
            jdbcConnectionConfiguration.setPassword(ConfigUtil.getStrProp("bus.password"));
            context.setJdbcConnectionConfiguration(jdbcConnectionConfiguration);

            JavaModelGeneratorConfiguration javaModelGeneratorConfiguration=new JavaModelGeneratorConfiguration();
            javaModelGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("bus.basePackage")+".model");
            javaModelGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("bus.ormPath") + "/java/");
            context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

            JavaClientGeneratorConfiguration javaClientGeneratorConfiguration=new JavaClientGeneratorConfiguration();
            javaClientGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("bus.basePackage") + ".dao");
            javaClientGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("bus.ormPath") + "/java/");
            javaClientGeneratorConfiguration.setConfigurationType("XMLMAPPER");
            context.setJavaClientGeneratorConfiguration(javaClientGeneratorConfiguration);

            SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration=new SqlMapGeneratorConfiguration();
            sqlMapGeneratorConfiguration.setTargetPackage("orm");
            sqlMapGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("bus.ormPath")+"/resources/");
            ...
            for(String tableName:tableList){
                ...
                tableConfiguration.setSchema(ConfigUtil.getStrProp("bus.database"));
                ...
                cleanFile(ConfigUtil.getStrProp("bus.ormPath")+"/resources/orm/"+tableConfiguration.getDomainObjectName()+"Mapper.xml");
            }
    ...
    class TemplateGenerate implements ProgressCallback {
        ...
        public TemplateGenerate(Configuration configuration){
            ...
            String basePackage=ConfigUtil.getStrProp("bus.basePackage");
            String controllerPackage=ConfigUtil.getStrProp("bus.controllerPackage");
            ...
            controllerPath=ConfigUtil.getStrProp("bus.controllerPath");
            ...
            mapperTemplate = ve.getTemplate("template-bus/mapperTemplate.vm");
            serviceTemplate = ve.getTemplate("template-bus/serviceTemplate.vm");
