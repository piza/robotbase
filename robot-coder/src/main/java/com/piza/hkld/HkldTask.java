 ...
 */
public class HkldTask extends TaskBase {

    private static final Logger logger= Logger.getLogger(HkldTask.class);
    ...
    public void run() {
        ...
        try {
            ...
            if(this.hasTaskItem("code")){
                HkldOrmTaskItem codeTaskItem=new HkldOrmTaskItem(this);
                codeTaskItem.work();
            }else if(this.hasTaskItem("java")){
                (new DeployHkldItem(this,false)).work();
            }else{
