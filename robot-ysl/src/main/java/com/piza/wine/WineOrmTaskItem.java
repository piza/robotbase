 ...
 *
 */
public class WineOrmTaskItem extends BaseItem {

    private static final Logger logger= Logger.getLogger(WineOrmTaskItem.class);

    public WineOrmTaskItem(TaskBase taskBase) {
        super(taskBase);
    }
...
//            sendChat("wrong param, example:\n code table1 table2 ...");
    ...
    private boolean commitCode(){
        ...
        try {
            String pullCmd = workingDir + File.separator + "commitProject.sh "+ConfigUtil.getStrProp("wine.projectDir");
    ...
    private void getTableList(List<String> tableList,String command){
        ...
        if(cmdArr.length<3){
            sendChat("wrong command: hint:\n wine code [tablename1] [tablename2] ...");
            return;
        }
        int ind=0;
    ...
    public boolean generate(List<String> tableList){
        ...
        try {
            ...
            configuration.addClasspathEntry(ConfigUtil.getStrProp("wine.classPathEntry"));
            ...
            jdbcConnectionConfiguration.setConnectionURL(ConfigUtil.getStrProp("wine.connectionURL"));
            jdbcConnectionConfiguration.setUserId(ConfigUtil.getStrProp("wine.userId"));
            jdbcConnectionConfiguration.setPassword(ConfigUtil.getStrProp("wine.password"));
            context.setJdbcConnectionConfiguration(jdbcConnectionConfiguration);

            JavaModelGeneratorConfiguration javaModelGeneratorConfiguration=new JavaModelGeneratorConfiguration();
            javaModelGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("wine.basePackage")+".model");
            javaModelGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("wine.ormPath") + "/java/");
            context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

            JavaClientGeneratorConfiguration javaClientGeneratorConfiguration=new JavaClientGeneratorConfiguration();
            javaClientGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("wine.basePackage") + ".dao");
            javaClientGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("wine.ormPath") + "/java/");
            javaClientGeneratorConfiguration.setConfigurationType("XMLMAPPER");
            context.setJavaClientGeneratorConfiguration(javaClientGeneratorConfiguration);

            SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration=new SqlMapGeneratorConfiguration();
            sqlMapGeneratorConfiguration.setTargetPackage("orm");
            sqlMapGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("wine.ormPath")+"/resources/");
            ...
            for(String tableName:tableList){
                ...
                tableConfiguration.setSchema(ConfigUtil.getStrProp("wine.database"));
                ...
                cleanFile(ConfigUtil.getStrProp("wine.ormPath")+"/resources/orm/"+tableConfiguration.getDomainObjectName()+"Mapper.xml");
            }
    ...
    class TemplateGenerate implements ProgressCallback {
        ...
        public TemplateGenerate(Configuration configuration){
            ...
            String basePackage=ConfigUtil.getStrProp("wine.basePackage");
            String controllerPackage=ConfigUtil.getStrProp("wine.controllerPackage");
            ...
            ormPath=ConfigUtil.getStrProp("wine.ormPath");
            servicePath=ConfigUtil.getStrProp("wine.servicePath");
            controllerPath=ConfigUtil.getStrProp("wine.controllerPath");


            basePackagePath=ConfigUtil.getStrProp("wine.basePackagePath");
            controllerPackagePath=ConfigUtil.getStrProp("wine.controllerPackagePath");

            ve = new VelocityEngine();
            ve.setProperty(RuntimeConstants.RESOURCE_LOADER, "classpath");
            ve.setProperty("classpath.resource.loader.class", ClasspathResourceLoader.class.getName());

            mapperTemplate = ve.getTemplate("template-wine/mapperTemplate.vm");
            serviceTemplate = ve.getTemplate("template-wine/serviceTemplate.vm");
