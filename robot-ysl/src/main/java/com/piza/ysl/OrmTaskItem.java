...
//            sendChat("wrong param, example:\n code table1 table2 ...");
    ...
    private boolean commitCode(){
        ...
        try {
            String pullCmd = workingDir + File.separator + "commitProject.sh "+ConfigUtil.getStrProp("ysl.projectDir");
    ...
    private void getTableList(List<String> tableList,String command){
        ...
        if(cmdArr.length<3){
            sendChat("wrong command: hint:\n ysl code [tablename1] [tablename2] ...");
            return;
        }
        int ind=0;
    ...
    public boolean generate(List<String> tableList){
        ...
        try {
            ...
            configuration.addClasspathEntry(ConfigUtil.getStrProp("ysl.classPathEntry"));
            ...
            jdbcConnectionConfiguration.setConnectionURL(ConfigUtil.getStrProp("ysl.connectionURL"));
            jdbcConnectionConfiguration.setUserId(ConfigUtil.getStrProp("ysl.userId"));
            jdbcConnectionConfiguration.setPassword(ConfigUtil.getStrProp("ysl.password"));
            context.setJdbcConnectionConfiguration(jdbcConnectionConfiguration);

            JavaModelGeneratorConfiguration javaModelGeneratorConfiguration=new JavaModelGeneratorConfiguration();
            javaModelGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("ysl.basePackage")+".model");
            javaModelGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("ysl.ormPath") + "/java/");
            context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

            JavaClientGeneratorConfiguration javaClientGeneratorConfiguration=new JavaClientGeneratorConfiguration();
            javaClientGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("ysl.basePackage") + ".dao");
            javaClientGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("ysl.ormPath") + "/java/");
            javaClientGeneratorConfiguration.setConfigurationType("XMLMAPPER");
            context.setJavaClientGeneratorConfiguration(javaClientGeneratorConfiguration);

            SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration=new SqlMapGeneratorConfiguration();
            sqlMapGeneratorConfiguration.setTargetPackage("orm");
            sqlMapGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("ysl.ormPath")+"/resources/");
            ...
            for(String tableName:tableList){
                ...
                tableConfiguration.setSchema(ConfigUtil.getStrProp("ysl.database"));
                ...
                cleanFile(ConfigUtil.getStrProp("ysl.ormPath")+"/resources/orm/"+tableConfiguration.getDomainObjectName()+"Mapper.xml");
            }
    ...
    class TemplateGenerate implements ProgressCallback {
        ...
        public TemplateGenerate(Configuration configuration){
            ...
            String basePackage=ConfigUtil.getStrProp("ysl.basePackage");
            String controllerPackage=ConfigUtil.getStrProp("ysl.controllerPackage");
            ...
            ormPath=ConfigUtil.getStrProp("ysl.ormPath");
            servicePath=ConfigUtil.getStrProp("ysl.servicePath");
            controllerPath=ConfigUtil.getStrProp("ysl.controllerPath");


            basePackagePath=ConfigUtil.getStrProp("ysl.basePackagePath");
            controllerPackagePath=ConfigUtil.getStrProp("ysl.controllerPackagePath");

            ve = new VelocityEngine();
            ve.setProperty(RuntimeConstants.RESOURCE_LOADER, "classpath");
            ve.setProperty("classpath.resource.loader.class", ClasspathResourceLoader.class.getName());

            mapperTemplate = ve.getTemplate("template-ysl/mapperTemplate.vm");
            serviceTemplate = ve.getTemplate("template-ysl/serviceTemplate.vm");
            implTemplate = ve.getTemplate("template-ysl/serviceImplTemplate.vm");
            validatorTemplate = ve.getTemplate("template-ysl/validatorTemplate.vm");
            controllerTemplate = ve.getTemplate("template-ysl/controllerTemplate.vm");
            apiTemplate = ve.getTemplate("template-ysl/apiTemplate.vm");
