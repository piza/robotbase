 ...
 *
 */
public class LanMengOrmTaskItem extends BaseItem {

    private static final Logger logger= Logger.getLogger(LanMengOrmTaskItem.class);

    public LanMengOrmTaskItem(TaskBase taskBase) {
        super(taskBase);
    }
...
//            sendChat("wrong param, example:\n code table1 table2 ...");
    ...
    private boolean commitCode(){
        ...
        try {
            String pullCmd = workingDir + File.separator + "commitProject.sh "+ConfigUtil.getStrProp("lanmeng.projectDir");
    ...
    private void getTableList(List<String> tableList,String command){
        ...
        if(cmdArr.length<3){
            sendChat("wrong command: hint:\n lanmeng code [tablename1] [tablename2] ...");
            return;
        }
        int ind=0;
    ...
    public boolean generate(List<String> tableList){
        ...
        try {
            ...
            configuration.addClasspathEntry(ConfigUtil.getStrProp("lanmeng.classPathEntry"));
            ...
            jdbcConnectionConfiguration.setConnectionURL(ConfigUtil.getStrProp("lanmeng.connectionURL"));
            jdbcConnectionConfiguration.setUserId(ConfigUtil.getStrProp("lanmeng.userId"));
            jdbcConnectionConfiguration.setPassword(ConfigUtil.getStrProp("lanmeng.password"));
            context.setJdbcConnectionConfiguration(jdbcConnectionConfiguration);

            JavaModelGeneratorConfiguration javaModelGeneratorConfiguration=new JavaModelGeneratorConfiguration();
            javaModelGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("lanmeng.basePackage")+".model");
            javaModelGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("lanmeng.ormPath") + "/java/");
            context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

            JavaClientGeneratorConfiguration javaClientGeneratorConfiguration=new JavaClientGeneratorConfiguration();
            javaClientGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("lanmeng.basePackage") + ".dao");
            javaClientGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("lanmeng.ormPath") + "/java/");
            javaClientGeneratorConfiguration.setConfigurationType("XMLMAPPER");
            context.setJavaClientGeneratorConfiguration(javaClientGeneratorConfiguration);

            SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration=new SqlMapGeneratorConfiguration();
            sqlMapGeneratorConfiguration.setTargetPackage("orm");
            sqlMapGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("lanmeng.ormPath")+"/resources/");
            ...
            for(String tableName:tableList){
                ...
                tableConfiguration.setSchema(ConfigUtil.getStrProp("lanmeng.database"));
                ...
                cleanFile(ConfigUtil.getStrProp("lanmeng.ormPath")+"/resources/orm/"+tableConfiguration.getDomainObjectName()+"Mapper.xml");
            }
    ...
    class TemplateGenerate implements ProgressCallback {
        ...
        public TemplateGenerate(Configuration configuration){
            ...
            String basePackage=ConfigUtil.getStrProp("lanmeng.basePackage");
            String controllerPackage=ConfigUtil.getStrProp("lanmeng.controllerPackage");
            ...
            ormPath=ConfigUtil.getStrProp("lanmeng.ormPath");
            servicePath=ConfigUtil.getStrProp("lanmeng.servicePath");
            controllerPath=ConfigUtil.getStrProp("lanmeng.controllerPath");


            basePackagePath=ConfigUtil.getStrProp("lanmeng.basePackagePath");
            controllerPackagePath=ConfigUtil.getStrProp("lanmeng.controllerPackagePath");

            ve = new VelocityEngine();
            ve.setProperty(RuntimeConstants.RESOURCE_LOADER, "classpath");
            ve.setProperty("classpath.resource.loader.class", ClasspathResourceLoader.class.getName());

            mapperTemplate = ve.getTemplate("template-lanmeng/mapperTemplate.vm");
            serviceTemplate = ve.getTemplate("template-lanmeng/serviceTemplate.vm");
            implTemplate = ve.getTemplate("template-lanmeng/serviceImplTemplate.vm");
            validatorTemplate = ve.getTemplate("template-lanmeng/validatorTemplate.vm");
            controllerTemplate = ve.getTemplate("template-lanmeng/controllerTemplate.vm");
//            apiTemplate = ve.getTemplate("template-lanmeng/apiTemplate.vm");
