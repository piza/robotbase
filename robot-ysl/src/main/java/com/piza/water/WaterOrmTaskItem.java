 ...
 *
 */
public class WaterOrmTaskItem extends BaseItem {

    private static final Logger logger= Logger.getLogger(WaterOrmTaskItem.class);

    public WaterOrmTaskItem(TaskBase taskBase) {
        super(taskBase);
    }
...
//            sendChat("wrong param, example:\n code table1 table2 ...");
    ...
    private boolean commitCode(){
        ...
        try {
            String pullCmd = workingDir + File.separator + "commitProject.sh "+ConfigUtil.getStrProp("water.projectDir");
    ...
    private void getTableList(List<String> tableList,String command){
        ...
        if(cmdArr.length<3){
            sendChat("wrong command: hint:\n water code [tablename1] [tablename2] ...");
            return;
        }
        int ind=0;
    ...
    public boolean generate(List<String> tableList){
        ...
        try {
            ...
            configuration.addClasspathEntry(ConfigUtil.getStrProp("water.classPathEntry"));
            ...
            jdbcConnectionConfiguration.setConnectionURL(ConfigUtil.getStrProp("water.connectionURL"));
            jdbcConnectionConfiguration.setUserId(ConfigUtil.getStrProp("water.userId"));
            jdbcConnectionConfiguration.setPassword(ConfigUtil.getStrProp("water.password"));
            context.setJdbcConnectionConfiguration(jdbcConnectionConfiguration);

            JavaModelGeneratorConfiguration javaModelGeneratorConfiguration=new JavaModelGeneratorConfiguration();
            javaModelGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("water.basePackage")+".model");
            javaModelGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("water.ormPath") + "/java/");
            context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

            JavaClientGeneratorConfiguration javaClientGeneratorConfiguration=new JavaClientGeneratorConfiguration();
            javaClientGeneratorConfiguration.setTargetPackage(ConfigUtil.getStrProp("water.basePackage") + ".dao");
            javaClientGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("water.ormPath") + "/java/");
            javaClientGeneratorConfiguration.setConfigurationType("XMLMAPPER");
            context.setJavaClientGeneratorConfiguration(javaClientGeneratorConfiguration);

            SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration=new SqlMapGeneratorConfiguration();
            sqlMapGeneratorConfiguration.setTargetPackage("orm");
            sqlMapGeneratorConfiguration.setTargetProject(ConfigUtil.getStrProp("water.ormPath")+"/resources/");
            ...
            for(String tableName:tableList){
                ...
                tableConfiguration.setSchema(ConfigUtil.getStrProp("water.database"));
                ...
                cleanFile(ConfigUtil.getStrProp("water.ormPath")+"/resources/orm/"+tableConfiguration.getDomainObjectName()+"Mapper.xml");
            }
    ...
    class TemplateGenerate implements ProgressCallback {
        ...
        public TemplateGenerate(Configuration configuration){
            ...
            String basePackage=ConfigUtil.getStrProp("water.basePackage");
            String controllerPackage=ConfigUtil.getStrProp("water.controllerPackage");
            ...
            ormPath=ConfigUtil.getStrProp("water.ormPath");
            servicePath=ConfigUtil.getStrProp("water.servicePath");
            controllerPath=ConfigUtil.getStrProp("water.controllerPath");


            basePackagePath=ConfigUtil.getStrProp("water.basePackagePath");
            controllerPackagePath=ConfigUtil.getStrProp("water.controllerPackagePath");

            ve = new VelocityEngine();
            ve.setProperty(RuntimeConstants.RESOURCE_LOADER, "classpath");
            ve.setProperty("classpath.resource.loader.class", ClasspathResourceLoader.class.getName());

            mapperTemplate = ve.getTemplate("template-water/mapperTemplate.vm");
            serviceTemplate = ve.getTemplate("template-water/serviceTemplate.vm");
            implTemplate = ve.getTemplate("template-water/serviceImplTemplate.vm");
            validatorTemplate = ve.getTemplate("template-water/validatorTemplate.vm");
            controllerTemplate = ve.getTemplate("template-water/controllerTemplate.vm");
